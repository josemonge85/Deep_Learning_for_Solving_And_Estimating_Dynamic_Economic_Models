...
% ---------- Title ----------
\title[Lecture 13 (B12)]{Lecture 13 (B12): OLG Models with DEQNs --- Analytic 6-Cohort Case}
\subtitle{Why OLG, Krueger--Kuebler 2004, DEQN architecture and training}
...
\begin{itemize}\itemsep2pt
  \item Why overlapping-generations models matter; the cohort structure
  \item Krueger-Kuebler 2004 analytic 6-cohort OLG model end-to-end
  \item DEQN architecture, sampling, training results vs the analytic benchmark
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lectures 06-09 (DEQN block)
  \item Lecture 11 (IRBC) for multi-shock training patterns
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 14 (large 56-cohort OLG benchmark)
\end{itemize}
\end{block}
\end{frame}
