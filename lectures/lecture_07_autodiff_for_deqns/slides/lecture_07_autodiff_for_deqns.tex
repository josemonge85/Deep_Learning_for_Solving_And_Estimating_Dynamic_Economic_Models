...
% ---------- Title ----------
\title[Lecture 06]{Lecture 06: Automatic differentiation for DEQNs}
...
\vspace{-0.4cm}
\begin{center}
{\footnotesize A primer for the autodiff notebooks (\texttt{02\_Brock\_Mirman\_AutoDiff\_DEQN}, \texttt{03\_Brock\_Mirman\_Uncertainty\_AutoDiff\_DEQN}).}\\[4pt]
...
\footnotesize The original Brock--Mirman notebook (\texttt{01\_Brock\_Mirman\_DEQN}; the autodiff version is \texttt{02\_Brock\_Mirman\_AutoDiff\_DEQN}) needed \emph{two pages} of algebra before we could code the loss:
\begin{center}
