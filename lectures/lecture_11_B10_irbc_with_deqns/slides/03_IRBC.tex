...
% ---------- Title ----------
\title[Lecture 11 (B10)]{Lecture 11 (B10): IRBC with DEQNs}
\subtitle{Solving the IRBC Model with DEQNs}
...
\textbf{Scheduled across two slots} (total $\approx 95$ min, split by NAS / Loss Normalization at 10:30--11:10).

\vspace{0.4em}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Slot A: 09:00--09:50}~~{\small(50 min)}
\begin{itemize}
    \item \textbf{Part I.} The IRBC model: preferences, production, TFP, adjustment costs, irreversibility, Fischer--Burmeister
    \item Equilibrium system + finger exercise (09:50--09:55)
\end{itemize}

\column{0.48\textwidth}
\textbf{Slot B: 11:15--12:00}~~{\small(45 min)}
\begin{itemize}
...
{\small Thursday morning, 09:00--12:00}
\end{center}
\end{columns}
\end{frame}
