...
% --- Claude Code Setup ---
\begin{frame}[fragile,shrink=8]{Claude Code: First Launch \& Key Commands}
\begin{columns}[T]
\column{0.48\textwidth}
\begin{lstlisting}[style=bash, basicstyle=\scriptsize\ttfamily]
...
% --- Exercise 1 ---
\begin{frame}[fragile,shrink=12]{Exercise 1: Environment Bootstrap {\small(15 min)}}
\small
...
\begin{enumerate}\itemsep1pt
    ...
    \item Copy \texttt{lectures/lecture\_06\_agentic\_programming/code/generate\_synthetic\_data.py} and run it once
...
\vspace{0.3em}
{\scriptsize See \texttt{lectures/lecture\_06\_agentic\_programming/code/exercise\_prompts.md} for copy-pasteable prompts.}
\end{columns}
\end{frame}
...
% --- Prompt Quality ---
\begin{frame}[fragile,shrink=8]{Prompt Quality Spectrum}
\small
...
\vspace{0.1em}
{\tiny Copy-pasteable version: \texttt{lectures/lecture\_06\_agentic\_programming/code/CLAUDE\_md\_template.md}}
\end{columns}
\end{frame}
...
\begin{enumerate}\itemsep2pt
    ...
    \item Copy the template from \texttt{lectures/lecture\_06\_agentic\_programming/code/CLAUDE\_md\_template.md}
...
\vspace{0.2em}
{\scriptsize Example skill file: \texttt{lectures/lecture\_06\_agentic\_programming/code/skills/example\_skill/SKILL.md}}
\end{columns}
\end{frame}
...
\textbf{In course repo:} \texttt{lectures/lecture\_06\_agentic\_programming/code/}\\
...
\vspace{0.2em}
\textbf{7 ready-made examples in \texttt{lectures/lecture\_06\_agentic\_programming/code/subagents/}:}
...
\scriptsize
Three domain-specific subagents in \texttt{lectures/lecture\_06\_agentic\_programming/code/subagents/}.
...
\emphc{Full file:} \texttt{lectures/lecture\_06\_agentic\_programming/code/hooks/settings.json}.
\end{columns}
...
\textbf{Solutions:} \texttt{lectures/lecture\_06\_agentic\_programming/code/exercise\_solutions.md}.
\end{frame}
...
\vspace{0.2em}
\emphc{Runnable reference:}~\selfstudy~\texttt{lectures/lecture\_06\_agentic\_programming/code/mincer\_demo.py}
...
\begin{frame}[shrink=8]{\selfstudy~~Mincer Demo: What Claude Produces}
\scriptsize
After \textasciitilde{}45 seconds Claude writes the script, runs it, and emits
the two artifacts below (actual outputs of \texttt{lectures/lecture\_06\_agentic\_programming/code/mincer\_demo.py}).
...
\small
Use \texttt{lectures/lecture\_06\_agentic\_programming/code/generate\_synthetic\_data.py} to create data, then build a mini pipeline:
\begin{enumerate}\itemsep0pt
