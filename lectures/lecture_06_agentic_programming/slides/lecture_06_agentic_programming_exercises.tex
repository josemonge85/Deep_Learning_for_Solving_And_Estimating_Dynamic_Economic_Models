...
\titlepage
\begin{center}
{\footnotesize Prompts: \texttt{lectures/lecture\_06\_agentic\_programming/code/exercise\_prompts.md}\\
Solution notes: \texttt{lectures/lecture\_06\_agentic\_programming/code/exercise\_solutions.md}\\[2pt]
...
\vspace{0.2em}
{\tiny Solutions in \texttt{lectures/lecture\_06\_agentic\_programming/code/exercise\_solutions.md}; consult only \emph{after} attempting.}
\end{frame}
...
\begin{enumerate}\itemsep2pt
    \item Copy \texttt{lectures/lecture\_06\_agentic\_programming/code/CLAUDE\_md\_template.md}
...
\textbf{Part A: Skill}
\begin{enumerate}\itemsep1pt
    \item Copy \texttt{lectures/lecture\_06\_agentic\_programming/code/skills/example\_skill/SKILL.md}
...
\begin{enumerate}\itemsep1pt
    \item Copy \texttt{lectures/lecture\_06\_agentic\_programming/code/subagents/}\\
    \texttt{verifier.md}
