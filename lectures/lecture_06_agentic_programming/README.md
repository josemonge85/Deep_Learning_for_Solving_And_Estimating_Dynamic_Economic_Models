# Lecture 06: Agentic programming
...
Curated bibliography for this lecture: [`lecture_06.md`](../../readings/links_by_lecture/lecture_06.md). The full BibTeX is in [`readings/bibliography.bib`](../../readings/bibliography.bib).

---

| ← Previous | Next → |
|---|---|
| [**Lecture 05: Architecture search and loss balancing**](../lecture_05_nas_loss_normalization/README.md)<br><sub>Random search, Hyperband, ReLoBRaLo, SoftAdapt, GradNorm</sub> | [**Lecture 07: Automatic differentiation for DEQNs**](../lecture_07_autodiff_for_deqns/README.md)<br><sub>Lagrangian primitives, two-tape gradients, IRBC autodiff</sub> |
