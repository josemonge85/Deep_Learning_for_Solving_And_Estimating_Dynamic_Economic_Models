...
\begin{itemize}\itemsep2pt
  \item Gaussian processes as a distribution over functions; squared-exponential and Mat\'ern kernels
  \item Posterior predictions and confidence intervals; learning kernel hyperparameters
  \item Deep kernel learning: combining a neural feature extractor with a GP layer
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 22 (deep surrogates)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 24 (Bayesian active learning for sample design)
  \item Lecture 25 (GPs as value-function surrogates inside DP)
\end{itemize}
\end{block}
\end{frame}
