...
\title[Lecture 26 (B25)]{Lecture 26 (B25): Structural Estimation via SMM}
\subtitle{Exercise --- Surrogate-Based Structural Estimation via SMM}
...
\smallskip
\begin{itemize}\itemsep0pt
  \item First factor: \emphc{exploit} -- favour $\theta$ with small SMM criterion
  \item Second factor: \emphc{explore} -- favour $\theta$ where the moment GP is uncertain
