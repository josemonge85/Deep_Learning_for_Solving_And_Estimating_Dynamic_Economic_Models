...
% ---------- Title ----------
\title[Lecture 10 (B09)]{Lecture 10 (B09): Automatic Differentiation for DEQNs}
\subtitle{Automatic Differentiation: a primer for Deep Equilibrium Nets}
...
\begin{itemize}\itemsep3pt
  \item \emphc{First-order conditions} of optimisation problems (consumer, firm, planner).
...
\item \emphc{Scaling laws}: $\partial V/\partial A$ for TFP $A$ is linear in $A$ -- useful for normalisation.
