...
% Self-study extension to Day 4 (Young/KS = optional reading)
% ============================================================================
...
\begin{itemize}\setlength\itemsep{0.3em}
    \item The Day 4 in-class lecture covers \textbf{Automatic Differentiation}, \textbf{Sequence-Space DEQNs}, and \textbf{OLG models} with DEQNs.
    ...
    \item Students interested in heterogeneous-agent work in discrete time should read this deck alongside the PINN-based continuous-time treatment in \textbf{Day 6}.
\end{itemize}
\end{frame}
}
...
% --- Notebook Map ---
\begin{frame}{Day 4 Core Notebook Map}
\footnotesize
\begin{columns}[T]
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\begin{center}
\textbf{Next up --- Session 2 opens May 4:}\\[6pt]
{\large Day 5: Agentic Programming}\\[4pt]
{\small Using AI agents for research}\\[10pt]
{\footnotesize Day 6: PINNs \& continuous-time HA\\
Day 7: Surrogates \& GPs\\
Day 8: Climate \& Deep UQ}
\end{center}
\end{columns}
\end{frame}
