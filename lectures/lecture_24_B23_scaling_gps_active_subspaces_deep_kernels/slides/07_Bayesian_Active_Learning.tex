...
\begin{itemize}\itemsep2pt
  \item Where to sample? Bayesian active learning as a principled answer
  \item The BAL algorithm; progressive refinement of a GP surrogate
  \item BAL applied in economics; combining BAL with GPs for high-quality surrogates
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 23 (GP regression)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 25 (GPs for dynamic programming)
\end{itemize}
\end{block}
\end{frame}
