...
% ---------- Title ----------
\title[Lecture 15 (B14)]{Lecture 15 (B14): Krusell--Smith and Young's Method}
\subtitle{Young's (2010) Method and Heterogeneous Agents in DEQNs}
...
\begin{itemize}\setlength\itemsep{0.3em}
    \item The autodiff and OLG lectures cover \textbf{Automatic Differentiation}, \textbf{Sequence-Space DEQNs}, and \textbf{OLG models} with DEQNs.
...
\vspace{0.4em}
\textbf{In this course.}  Notebook \texttt{12\_KrusellSmith\_DeepLearning.ipynb} is a classroom-scale caricature of this approach: single policy network, panel of $N \sim 100$ agents, CPU-friendly, $\sim$10 min to convergence.
\end{frame}
...
& \quad\emph{Self-contained, CPU-friendly, $\sim$10 min training.} \\
\addlinespace
...
\vspace{0.3em}
{\footnotesize All notebooks are on \emphc{Nuvolos Cloud} and the course GitHub repository.}
\end{frame}
