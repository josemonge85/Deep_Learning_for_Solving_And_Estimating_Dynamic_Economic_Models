...
\subtitle{Heterogeneous agents, the KS insight, non-stochastic distribution updates}
...
\begin{itemize}\itemsep2pt
  \item From representative to heterogeneous agents; the infinite-dimensional state-space problem
  \item The Krusell-Smith insight: approximate aggregation
  \item Young's (2010) non-stochastic distribution update; the traditional Krusell-Smith outer loop
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 14 (large OLG)
  \item Lecture 06 (DEQN central idea)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 16 (continuum-agent DEQNs and the method-comparison landscape)
\end{itemize}
\end{block}
\end{frame}
