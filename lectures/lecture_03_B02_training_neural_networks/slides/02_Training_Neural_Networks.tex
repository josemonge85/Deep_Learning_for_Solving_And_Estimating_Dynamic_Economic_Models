...
\begin{itemize}\itemsep2pt
  \item From the perceptron to multilayer feedforward networks; activation functions
  \item Gradient descent, stochastic gradient descent, mini-batches
  \item Backpropagation, modern optimizers (Adam / AdamW), weight initialization, batch normalization
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 02 (motivation, the ML pipeline)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 04 (generalization, regularization, sequence models)
  \item Lecture 05 (function approximation and loss design)
\end{itemize}
\end{block}
\end{frame}
