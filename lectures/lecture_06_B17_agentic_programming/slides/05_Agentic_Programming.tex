...
% --- Recap of Day 4 / Bridge to Day 5 ---
\begin{frame}{From Day 4 to Day 5: From Models to the Workflow That Ships Them}
\small
\begin{columns}[T]
\column{0.50\textwidth}
\textbf{Days 1--4 built the models.}
\begin{itemize}\itemsep0pt
    \item Day 1: deep-learning fundamentals
    \item Day 2: Deep Equilibrium Nets (DEQNs)
    \item Day 3: IRBC, NAS, loss normalization
    \item Day 4: autodiff, sequence space, OLG
\end{itemize}
...
\textbf{Day 5 builds the \emphc{workflow}.}
\begin{itemize}\itemsep0pt
...
% --- Bridge to Day 6 ---
\begin{frame}{Tomorrow: Day 6 --- PINNs \& Continuous-Time HA Models}
\small
\begin{columns}[T]
\column{0.55\textwidth}
...
\column{0.43\textwidth}
\begin{block}{Suggested workflow for Day 6}
\scriptsize
