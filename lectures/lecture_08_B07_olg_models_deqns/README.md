...
Curated bibliography for this lecture: [`lecture_08_B07.md`](../../readings/links_by_lecture/lecture_08_B07.md). The full BibTeX is in [`readings/bibliography.bib`](../../readings/bibliography.bib).

---

← [Previous: Sequence-space DEQNs](../lecture_07_B06_sequence_space_deqns/README.md) · → [Next: Heterogeneous agents and Young's method](../lecture_09_B08_heterogeneous_agents_youngs_method/README.md) · [Course map](../../COURSE_MAP.md)
