...
% Deep Learning in Economics and Finance -- University of Geneva, April 2026
% Duration: 55 min (Day 4 OLG slot)
%
...
% --- Bridge to Day 5 ---------------------------------------------------
\begin{frame}{Bridge to Day 5: Agentic Programming}
\footnotesize
...
\vspace{0.4em}
\textbf{Day 5 (workshop, no lecture script chapter).}  We turn the workflow on its head and treat the model file, the loss, and the diagnostics as artefacts that an LLM-driven coding agent can author, refactor, and debug in conversation.  Concretely, you will:
\begin{itemize}\itemsep1pt
...
\vspace{0.4em}
\textbf{Self-study extension (notebooks 10--12, deck 08).}  Heterogeneous agents on a histogram (Young's method), continuum-of-agents DEQN, and Krusell--Smith with deep learning.  These pieces sit \emph{above} today's OLG content and can be revisited any time before the Day 6 PINN material.
\end{frame}
