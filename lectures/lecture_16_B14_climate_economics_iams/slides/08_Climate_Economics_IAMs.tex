...
\small
The companion notebooks for this lecture sit in \texttt{lectures/lecture\_16\_B14\_climate\_economics\_iams/code/} and are intended to be opened in this order:
\vspace{0.2cm}
\begin{enumerate}
