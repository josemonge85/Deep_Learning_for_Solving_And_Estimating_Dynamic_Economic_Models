...
\vspace{0.2cm}
\begin{itemize}
    \item \texttt{lectures/lecture\_16\_B14\_climate\_economics\_iams/code/lecture\_16\_B14\_03\_Stochastic\_DICE\_DEQN.ipynb} -- adds an AR(1) productivity shock to the Lecture-08 deterministic CDICE-DEQN, evaluates the Euler expectation with Gauss--Hermite quadrature, and produces the SCC fan charts that motivate today's UQ discussion (parameter, stochastic, and epistemic uncertainty).
\end{itemize}
\vspace{0.2cm}
...
\begin{itemize}
    \item \texttt{readings/links\_by\_lecture/lecture\_17\_B15.md}
\end{itemize}
