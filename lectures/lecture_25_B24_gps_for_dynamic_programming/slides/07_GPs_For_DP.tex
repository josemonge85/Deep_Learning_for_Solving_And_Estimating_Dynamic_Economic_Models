...
\begin{itemize}\itemsep2pt
  \item Adaptive sparse GP value-function iteration (ASGP-VFI)
  \item Active subspaces (linear and deep) for high-dimensional state spaces
  \item Embarrassingly parallel VFI; head-to-head with DEQNs
\end{itemize}
\end{block}
...
\begin{itemize}\itemsep2pt
  \item Lecture 26 (SMM with GP surrogates)
  \item Lectures 27-28 (climate IAMs)
\end{itemize}
\end{block}
\end{frame}
