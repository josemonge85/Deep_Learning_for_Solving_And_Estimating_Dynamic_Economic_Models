...
% ---------- Title ----------
\title[Lecture 06 (B05)]{Lecture 06 (B05): Deep Equilibrium Nets --- The Central Idea}
\subtitle{Deep Equilibrium Nets (DEQNs)}
...
\hrule
\vspace{0.2em}
{\footnotesize Wrap-up: \textbf{hands-on notebooks} on Nuvolos Cloud.  Notebook 01 reproduces the slide derivation; 02 adds AR(1) productivity shocks; 03/04 are the blank/solved versions of the morning's exercises.}
\end{frame}

% --- Slide 3: Roadmap ---
\begin{frame}{Roadmap of This Lecture (75 min)}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Motivation}~~{\small(14 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{From ANNs to DEQNs}~~{\small(25 min)}
\begin{itemize}
...
\column{0.48\textwidth}
\textbf{Brock--Mirman Benchmark}~~{\small(18 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{Parallelization \& HPC}~~{\small(10 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{Wrap-up + Hands-on}~~{\small(10 min)}
\begin{itemize}
...
\footnotesize
The loss kernel is a \emphc{modelling decision}, not a default.  Same Euler residual $r$, same network, same data, only the reduction $r\!\mapsto\!\ell$ changes:
...
\vspace{0.2em}
{\scriptsize Companion notebook: \texttt{lectures/day2/code/05\_StochasticBM\_LossComparison.ipynb}.}
\end{frame}
...
% --- Slide 31a: Preview of the morning exercises (KKT/FB) ---
\begin{frame}{Preview: the Morning Exercises (10:45--12:00)}
\footnotesize
...
\begin{enumerate}\itemsep2pt
    ...
    \item \texttt{03\_DEQN\_Exercises\_Blanks.ipynb} (morning exercises, blank template for student populate)

    \item \texttt{04\_DEQN\_Exercises\_Solutions.ipynb} (morning exercises, solved)
\end{enumerate}
...
\vspace{0.4em}
All notebooks are on \emphc{Nuvolos Cloud} and the course GitHub repository.
\end{frame}
