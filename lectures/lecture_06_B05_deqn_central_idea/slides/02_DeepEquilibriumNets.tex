...
\subtitle{Heterogeneity, high-dimensional state spaces, the DEQN solution}
...
\begin{itemize}\itemsep2pt
  \item Why DSGE models are computationally hard: heterogeneity and high-dimensional state spaces
  \item The ergodic set is not a hypercube; volumes scale badly in high dimensions
  \item The Deep Equilibrium Net (DEQN) approach in abstract: what is being learned, and against what target
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lectures 02-05 (deep learning foundations)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 07 (Brock-Mirman deterministic case, end-to-end)
  \item Lecture 08 (uncertainty and integration)
  \item Lecture 09 (constraints and loss-kernel design)
\end{itemize}
\end{block}
\end{frame}
