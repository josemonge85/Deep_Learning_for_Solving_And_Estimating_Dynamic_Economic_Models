...
\begin{enumerate}
    ...
    \vspace{0.3em}
    \item \texttt{lecture\_05\_05\_IRBC\_Exercise.ipynb} -- \emph{hands-on exercise (lives in L05's \texttt{code/}, extends naturally into the NAS / loss-normalization material of Chapter~4)}
    \begin{itemize}\itemsep1pt\vspace{2pt}
