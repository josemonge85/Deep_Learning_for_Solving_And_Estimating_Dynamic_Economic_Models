# Lecture 18 (B16): Course wrap-up

Synthesis of the course: when to choose which method, and where the literature is moving.

`cpu-light` · `short` · builds on [Lecture 17 (B15)](../lecture_17_B15_deep_uq_pareto_improving_policy/README.md)

> 📑 **Slides:** [10_Wrap_Up.pdf](slides/10_Wrap_Up.pdf)  
> 📚 **Further reading:** [curated list](../../readings/links_by_lecture/lecture_18_B16.md)  
...
Curated bibliography for this lecture: [`lecture_18_B16.md`](../../readings/links_by_lecture/lecture_18_B16.md). The full BibTeX is in [`readings/bibliography.bib`](../../readings/bibliography.bib).
