...
\vspace{-0.4cm}
\begin{center}
{\footnotesize Closing lecture: climate economics, deep UQ, and policy design}\\[4pt]
...
\node[phasebox, fill=softblue!25]   (d2) at (2.3,0)  {the discrete-time lectures\\DEQN solvers};
