...
6 & Heterogeneous agents, OLG, and Young's method (sequence space, Krusell--Smith) \\
...
\vspace{0.15cm}
\footnotesize
One model, four lenses. The economic content is identical; the methodology determines what is approximated and what diagnostic certifies convergence.  Companion notebooks in L03/B02, L11/B09, L14/B12, L15/B13.
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{Real-time policy analysis.}  Substantial speedups of full DSGE counterfactuals; carbon-tax surrogates (K\"ubler--Scheidegger--Surbek 2025).
...
\begin{itemize}
    \item \texttt{readings/links\_by\_lecture/lecture\_17\_B15.md} \hfill (Deep UQ + DICE-2P)
    \item \texttt{readings/links\_by\_lecture/lecture\_18\_B16.md} \hfill (CDICE production + JPE Macro)
\end{itemize}
