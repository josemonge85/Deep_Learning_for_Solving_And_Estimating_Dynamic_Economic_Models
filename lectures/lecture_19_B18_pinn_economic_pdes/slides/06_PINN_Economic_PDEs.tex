...
\begin{itemize}\itemsep2pt
  \item Soft vs hard boundary-condition enforcement; trial-solution decomposition
  \item PINN for the HJB equation (cake-eating); the DGM architecture for high-D PDEs
  \item PINN for the Black-Scholes PDE
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 18 (PINN foundations)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 20+ (continuous-time heterogeneous agents)
\end{itemize}
\end{block}
\end{frame}
