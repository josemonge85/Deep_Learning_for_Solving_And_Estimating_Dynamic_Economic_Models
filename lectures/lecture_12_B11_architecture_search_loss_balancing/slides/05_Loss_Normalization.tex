...
\subtitle{Multi-Component Loss Balancing for Deep Learning}
...
\vspace{0.4em}
\textbf{II. Balancing Methods}~~{\small(12 min)}
\begin{itemize}
...
\column{0.48\textwidth}
\textbf{III. Experiments \& Wrap-up}~~{\small(4 min)}
\begin{itemize}
...
\end{center}
{\scriptsize Generated by \texttt{04\_Loss\_Normalization.ipynb} (cell 16).  Bars show the total relative error $\sum_i \mathrm{MAE}_i / \text{scale}_i$ at the end of training, swept over $T \in \{0.01, 0.1, 1.0, 10.0\}$.}
...
\begin{itemize}\itemsep0pt
    \item Bischof \& Kraus (2025). \emph{Multi-Objective Loss Balancing for PINNs}, \emph{CMAME} 441, 117914.
