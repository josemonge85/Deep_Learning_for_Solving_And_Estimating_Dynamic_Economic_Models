...
\begin{enumerate}\itemsep4pt
    ...
    \item Ergodicity-and-truncation: long histories of exogenous shocks summarise the relevant economic state, with truncation error decaying geometrically.
...
\begin{itemize}\itemsep5pt
    ...
    \item Carroll, C.D.\ (2006). The method of endogenous gridpoints for solving dynamic stochastic optimisation problems. \emph{Economics Letters} 91(3), 312--320.
...
\begin{itemize}\itemsep2pt
    \item Choose $c_t$ to maximise $\mathbb{E}_0\sum_{t\ge 0}\beta^t \log c_t$.
...
{\footnotesize Use \emphc{residual minimisation} by default.  Switch to \emphc{time iteration} when convergence stalls, when the Euler equation has multiple roots, or when discrete choices appear in the optimisation.}
\end{block}
\end{frame}
