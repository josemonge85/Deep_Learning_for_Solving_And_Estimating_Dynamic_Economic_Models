...
Curated bibliography for this lecture: [`lecture_11_B10.md`](../../readings/links_by_lecture/lecture_11_B10.md). The full BibTeX is in [`readings/bibliography.bib`](../../readings/bibliography.bib).

---

← [Previous: Physics-informed neural networks](../lecture_10_B09_pinns/README.md) · → [Next: Continuous-time heterogeneous agents, numerics](../lecture_12_B11_continuous_time_ha_numerics/README.md) · [Course map](../../COURSE_MAP.md)
