...
\smallskip
{\scriptsize Comparison of GP design strategies on a smooth 2D test target $V(k_1,k_2)$ used to isolate the role of design geometry in two dimensions. Active design places points where $\sigma_{\text{GP}}$ is largest. (Notebook 04, cell 25.)}
\end{frame}
