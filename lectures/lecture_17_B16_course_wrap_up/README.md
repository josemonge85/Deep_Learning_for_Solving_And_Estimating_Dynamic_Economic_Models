...
Curated bibliography for this lecture: [`lecture_17_B16.md`](../../readings/links_by_lecture/lecture_17_B16.md). The full BibTeX is in [`readings/bibliography.bib`](../../readings/bibliography.bib).

---

← [Previous: Deep uncertainty quantification and Pareto-improving climate policy](../lecture_16_B15_deep_uq_pareto_improving_policy/README.md) · [Course map](../../COURSE_MAP.md)
