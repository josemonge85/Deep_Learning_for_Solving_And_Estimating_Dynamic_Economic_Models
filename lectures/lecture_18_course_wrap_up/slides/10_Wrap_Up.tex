...
\begin{itemize}
    \item \texttt{readings/links\_by\_lecture/lecture\_17.md} \hfill (Deep UQ + DICE-2P)
    \item \texttt{readings/links\_by\_lecture/lecture\_18.md} \hfill (CDICE production + JPE Macro)
\end{itemize}
