...
% ---------- Title ----------
\title[Lecture 02 (B01)]{Lecture 02 (B01): Why Deep Learning for Economics and Finance?}
...
\textbf{Cloud platform:}~~\url{https://nuvolos.cloud}
\end{center}
\end{frame}
...
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Machine Learning Foundations}~~{\small(15 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{From Perceptrons to Deep Nets}~~{\small(20 min)}
\begin{itemize}
...
\column{0.48\textwidth}
\textbf{Training, Generalization \& Practice}~~{\small(35 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{Sequence Models}~~{\small(20 min)}
\begin{itemize}
