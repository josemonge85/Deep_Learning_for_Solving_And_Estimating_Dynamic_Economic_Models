...
\begin{itemize}\itemsep2pt
  \item Why deep learning matters for economics and finance, with concrete applications
  \item The supervised, unsupervised, and reinforcement-learning paradigms
  \item The end-to-end machine-learning pipeline (data, model, loss, optimization, validation)
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Basic linear algebra, calculus, probability
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 03 (training neural networks): SGD, backpropagation, optimizer choice
\end{itemize}
\end{block}
\end{frame}
