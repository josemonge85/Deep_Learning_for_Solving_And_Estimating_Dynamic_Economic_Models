...
\subtitle{Climate Economics and Stochastic IAMs with DEQNs}
...
\vspace{-0.4cm}
\begin{center}
{\footnotesize Based on: Nordhaus (2017), Folini, Friedl, K\"ubler, Scheidegger (2024, \textit{Restud}),}\\[1pt]
{\footnotesize Friedl, K\"ubler, Scheidegger, Usui (2023)}\\[4pt]
{\footnotesize Readings: \texttt{CDICE\_Restud\_production.pdf}, \texttt{DeepUQ\_with\_an\_application\_to\_IAM.pdf}}\\[4pt]
...
\vspace{0.3cm}
\textbf{This lecture} ($\sim$75 min):
\begin{enumerate}
    \item Motivation: why climate economics? ($\sim$12 min)
    \item The DICE/CDICE climate model ($\sim$18 min)
    \item A stochastic IAM: full model and derivation ($\sim$25 min)
    \item Deep uncertainty quantification ($\sim$18 min)
\end{enumerate}
\end{frame}
...
\small
The companion notebooks for this lecture sit in \texttt{lectures/day8/code/} and are intended to be opened in this order:
\vspace{0.2cm}
\begin{enumerate}
