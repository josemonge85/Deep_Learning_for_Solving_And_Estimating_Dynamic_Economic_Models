...
\begin{itemize}\itemsep2pt
  \item Stochastic Brock-Mirman: residual, expectation, loss
  \item Numerical integration: Gauss-Hermite, monomial (Stroud-3) rules, cost trade-offs
  \item Training diagnostics: what does "converged" actually look like?
\end{itemize}
\end{block}
\begin{block}{Builds on}
\begin{itemize}\itemsep2pt
  \item Lecture 07 (deterministic DEQN end-to-end)
\end{itemize}
\end{block}
\begin{block}{Leads to}
\begin{itemize}\itemsep2pt
  \item Lecture 09 (constraints, residual kernels, loss design)
\end{itemize}
\end{block}
\end{frame}
