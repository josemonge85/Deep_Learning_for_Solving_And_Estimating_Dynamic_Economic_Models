...
% ---------- Title ----------
\title[Lecture 29 (B28)]{Lecture 29 (B28): Deep Uncertainty Quantification and Policy}
\subtitle{Constrained Optimal Carbon Tax in a Stochastic OLG-IAM}
...
% --- Frame 2: Outline ---
\begin{frame}{Outline of This Lecture ($\sim$75 min)}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Part I: Motivation}~~{\small($\sim$10 min)}
\begin{itemize}
...
\vspace{0.4em}
\textbf{Part II: The OLG-IAM Model}~~{\small($\sim$15 min)}
\begin{itemize}
...
\column{0.48\textwidth}
\textbf{Part III: Full Derivation}~~{\small($\sim$20 min)}
\begin{itemize}
...
\vspace{0.4em}
\textbf{Part IV: 3-Step Pipeline}~~{\small($\sim$15 min)}

\textbf{Part V: Results}~~{\small($\sim$13 min)}
