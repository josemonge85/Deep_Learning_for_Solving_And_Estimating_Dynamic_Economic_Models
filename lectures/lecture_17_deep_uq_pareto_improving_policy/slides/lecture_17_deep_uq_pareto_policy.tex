...
\vspace{0.1cm}
\footnotesize
Emissions and temperature paths under no climate policy, compared with RCP scenarios.  Source: Kübler, Scheidegger, Surbek (2025).
\end{frame}
...
\end{columns}
\vspace{0.05cm}
{\footnotesize Source: Kübler, Scheidegger, Surbek (2025).}
\end{frame}
...
\vspace{0.15cm}
\footnotesize
Left: Pareto frontier in $(\vartheta_0, \vartheta_E)$-space. Right: welfare gains by cohort --- \emphc{all non-negative} under Pareto-improving policy.  Source: Kübler, Scheidegger, Surbek (2025).
\end{frame}
...
the tax responds to carbon intensity and tipping proximity, providing tipping-risk insurance.  Source: Kübler, Scheidegger, Surbek (2025).
\end{frame}
