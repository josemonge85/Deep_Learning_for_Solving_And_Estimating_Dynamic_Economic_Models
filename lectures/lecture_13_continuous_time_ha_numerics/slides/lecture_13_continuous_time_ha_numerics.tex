...
\begin{enumerate}\itemsep0pt
  ...
  \item \textbf{NB\,08}: add the \emphc{KFE} for stationary distribution +
...
Notebook~08 adds the KFE and equilibrium conditions $\to$ \emphc{full Aiyagari}.}}
\end{frame}
...
\begin{itemize}\itemsep2pt
    ...
    \item \textbf{NB 09} \textit{(homework warm-up)}: \texttt{09\_PINN\_Exercise.ipynb} --- toy 1D ODE $u''+u=0$ on $[0,\pi]$ with hard zero BCs; a low-stakes PINN scaffold before tackling the HJB exercises in NB~08
\end{itemize}
