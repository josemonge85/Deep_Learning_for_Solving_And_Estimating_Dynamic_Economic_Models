...
{\footnotesize It generalises to two discrete income states and to OU diffusion income; Notebook 08 instead takes the $c=(V_a)^{-1/\gamma}$ route and outputs $(V,g)$ for the coupled HJB--KFE system.}
\end{frame}
