...
\begin{frame}{Epstein--Zin + i.i.d.\ weather: model ingredients}
\small
...
\begin{frame}{Epstein--Zin: the 9-residual loss}
\footnotesize
...
\begin{frame}{$\gamma$-curriculum and training diagnostics}
\footnotesize
