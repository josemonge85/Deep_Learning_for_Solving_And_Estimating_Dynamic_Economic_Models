...
% ---------- Title ----------
\title[Lecture 18 (B17)]{Lecture 18 (B17): PINNs I --- Residual Learning for ODEs and PDEs}
...
\textbf{From DEQNs to PINNs}~~{\small(10 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{PINN Fundamentals}~~{\small(20 min)}
\begin{itemize}
...
\column{0.48\textwidth}
\textbf{Boundary Conditions}~~{\small(15 min)}
\begin{itemize}
...
\vspace{0.5em}
\textbf{Econ \& Finance}~~{\small(30 min)}
\begin{itemize}
