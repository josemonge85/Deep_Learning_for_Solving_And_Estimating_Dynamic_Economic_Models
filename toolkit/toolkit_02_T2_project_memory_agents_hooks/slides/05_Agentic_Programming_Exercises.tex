% ============================================================================
% Toolkit T2: Project Memory, Agents, and Hooks
...
% ---------- Title ----------
\title[Toolkit T2]{Toolkit T2: Project Memory, Agents, and Hooks}
\subtitle{Agentic Programming: Exercises \& Solution Sketches}
...
\titlepage
\begin{center}
{\footnotesize Prompts: \texttt{day5/code/exercise\_prompts.md}\\
Solution notes: \texttt{day5/code/exercise\_solutions.md}\\[2pt]
...
\vspace{0.2em}
{\tiny Solutions in \texttt{day5/code/exercise\_solutions.md}; consult only \emph{after} attempting.}
\end{frame}
...
\begin{enumerate}\itemsep2pt
    \item Copy \texttt{day5/code/CLAUDE\_md\_template.md}
...
\textbf{Part A: Skill}
\begin{enumerate}\itemsep1pt
    \item Copy \texttt{day5/code/example\_skill/SKILL.md}
...
\begin{enumerate}\itemsep1pt
    \item Copy \texttt{day5/code/example\_subagent/}\\
    \texttt{verifier.md}
...
\textcolor{harvardcrimson}{\textbf{Advanced}} (DEQN from Days 1--4)
